...
public class JavaStreamsDemo {
    ...
    public static void main(String[] args) {
        ...
        System.out.println();
        soutAllLongerThan2(new String[]{"Ala", "Zosia", "John", "Mike", "Miu"}, 3);
        chainOrderDemo();
        supplierDemo();
        collectorListDemo();
    ...
    private static void soutAllLongerThan2(String[] strings, int limit) {
        Arrays.stream(strings).filter(s -> s.length() > limit)
                .map(s -> s.toUpperCase())
