package io.github.guit4rfre4k.examples.codewars.positions_avarage;
...
public class PositionAverageTest {
    ...
    public void getNumberOfEquals() {
        Assert.assertEquals(0, PositionAverage.getNumberOfEquals("111", "222"));
        Assert.assertEquals(1, PositionAverage.getNumberOfEquals("111", "221"));
        Assert.assertEquals(3, PositionAverage.getNumberOfEquals("111", "111"));
        Assert.assertEquals(5, PositionAverage.getNumberOfEquals("111111111111", "431215412110"));
        Assert.assertEquals(0, PositionAverage.getNumberOfEquals("1234567890", "0987654321"));
    }
