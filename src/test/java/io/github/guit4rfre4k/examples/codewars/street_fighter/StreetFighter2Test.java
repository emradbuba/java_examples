package io.github.guit4rfre4k.examples.codewars.street_fighter;
...
public class StreetFighter2Test {
    ...
    public void shouldWorkWithNoMoves() {
        ...
        assertEquals(solution, StreetFighter2.superStreetFighterize(fighters, new int[]{0,1}, new String[]{}));
    }
    ...
    public void shouldWorkWithFewMoves(){
        ...
        assertEquals(solution, StreetFighter2.superStreetFighterize(fighters, position, moves));
    }
    ...
    public void shouldRotateOnAllRows3(){
        ...
        assertEquals(solution, StreetFighter2.superStreetFighterize(fighters3, position, moves));
    }
    ...
    public void shouldWorkWithLongerGrid4(){
        ...
        assertEquals(solution, StreetFighter2.superStreetFighterize(fighters4, position, moves));
    }
